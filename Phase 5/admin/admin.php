...
<body>
    ...
    <header>
        ...
        <button type="button"><a href="../auth_process.php?action=logout" class="logout">Logout</a></button>
        <?php
        // if (auth()==false) echo "false";
        ...
        <tr>
            ...
            <td>
                <fieldset class="cat">
                    ...
                    <form id="cat_insert" method="POST" action="admin-process.php?action=<?php echo ($action ='cat_delete');?>" enctype="multipart/form-data">
        ...
        <tr>
            <td>
                <fieldset class="cat">
                    ...
                    <form id="cat_insert" method="POST" action="admin-process.php?action=<?php echo ($action ='cat_edit');?>" enctype="multipart/form-data">
        ...
        <tr>
            ...
            <td>
                <fieldset class="prod">
                    ...
                    <form id="prod_insert" method="POST" action="admin-process.php?action=<?php echo ($action ='prod_edit');?>" enctype="multipart/form-data">
        ...
        <tr>
            <td>
                <fieldset class="prod">
                    ...
                    <form id="prod_insert" method="POST" action="admin-process.php?action=<?php echo ($action ='prod_delete_by_catid');?>" enctype="multipart/form-data">
                        <label for="prod_pid">CATID *</label>
            ...
            <td>
                <fieldset class="prod">
                    ...
                    <form id="prod_insert" method="POST" action="admin-process.php?action=<?php echo ($action ='prod_delete');?>" enctype="multipart/form-data">
    ...
    <table id="order_record">
        <tr>
            <th>Invoice numuber</th>
            <th>TXN ID</th>
            <th>Digest order message</th>
            <th>Salt</th>
            <th>Payment Type</th>
        ...
        foreach ($order as $o){
            ...
            <tr> 
                ...
                <td><?php echo htmlspecialchars($o["ORMSG"]);   ?></td>
                <td><?php echo htmlspecialchars($o["SALT"]);   ?></td>
